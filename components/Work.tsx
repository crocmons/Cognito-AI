...
const Work = () => {
  return (
      <FadeIn>
        <div className=" flex max-w-5xl flex-col items-center text-center justify-center mx-auto px-2 mt-5 md:mt-16" id="work">
          <h2 className=" bold-40 lg:bold-64 py-2 text-black">Our Works</h2>
