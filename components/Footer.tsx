...
const Footer = () => {
  return (
    <footer className="flexCenter mb-24 text-black">
      <div className="padding-container max-container flex w-full flex-col gap-14">
        <div className="flex flex-col items-start justify-center gap-[10%] md:flex-row">
          <Link href="/" className="mb-10">
            <Image src="/cognito.svg" alt="logo" width={200} height={200} />
          </Link>
        ...
        <p className="regular-14 w-full text-center text-gray-30">2023 Cognito-AI | All rights reserved</p>
      </div>
